 ...
 */
public class ParserSpecificationTest {
    TomlParser tomlParser = new AntlrTomlParser();
    ...
    public void testNull() {
        Toml toml = Toml.parse("foo = 1337", tomlParser);
    ...
    public void testSerialization() throws Exception {
        ...
        Toml toml = Toml.parse(tomlContent, tomlParser);
        Foo foo = toml.getAs("foo", Foo.class);
