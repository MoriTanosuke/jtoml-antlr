...
/**
 * Junit test for the toml example file from toml "spec" (https://github.com/mojombo/toml).
 * 
...
public class ExampleTomlTest {
    ...
    public static void parseExampleFile() throws FileNotFoundException {
        ...
        String exampleToml = new Scanner(new File("src/test/resources/example.toml")).useDelimiter("\\Z").next();
    ...
    public void testDate() throws ParseException {
        ...
        assertEquals(createCalendar("yyyy-MM-dd-HH:mm:ssZ", "1979-05-27-07:32:00-0000"), toml.getDate("owner.dob"));
    }
    ...
    public void testArray() {
        ...
        assertEquals(createList(Long.valueOf(8001), Long.valueOf(8001), Long.valueOf(8002)),
    ...
    public void testLong() {
        ...
        assertEquals(Long.valueOf(5000), toml.getLong("database.connection_max"));
    ...
    public void testBoolean() {
        ...
        assertEquals(Boolean.valueOf(false), toml.getBoolean("database.awesome"));
    }
    ...
    public void testArrayOfArrays() {
        ...
        // parsers support it
        assertEquals(
                ExampleTomlTest.<Object> createList(createList("gamma", "delta"),
                        createList(Long.valueOf(1), Long.valueOf(2))), toml.getList("clients.data"));
    }

    private static Calendar createCalendar(String pattern, String value) throws ParseException {
